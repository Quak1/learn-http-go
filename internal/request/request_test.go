...
func TestRequestLineParse(t *testing.T) {
	...
	// Test: Good GET Request line with path short chunk
	reader = &chunkReader{
	...
	// Test: Good GET Request line with path long chunk
	reader = &chunkReader{
		data:            "GET /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 100,
	}
	...
	// Test: Invalid number of parts in request line
	reader = &chunkReader{
		data:            "GET /coffee coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
	}
	_, err = RequestFromReader(reader)
	require.Error(t, err)
...
func TestHeadersParse(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotNil(t, r)
	assert.Equal(t, "test-head, head-test", r.Headers["test"])
	assert.Equal(t, "*/*", r.Headers["accept"])
